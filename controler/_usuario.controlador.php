...
require_once "model/perfil.php";
    ...
    class UsuarioControlador{
        ...
        public function Atender(){
            ...
            if($siguiente){
                $turnohistorial=new TurnoHistorial();
                $turnohistorial->ActualizarEstado($idTurno,3);//3 es el estado ATENDIDO
                require_once "view/dash/headerDash.php";
                require_once "view/dash/head.php";
                require_once "view/dash/sidebarMenu.php";
        ...
        public function Ausente(){
            ...
            if($siguiente){
                $turnohistorial=new TurnoHistorial();
                $turnohistorial->CierraEstado($idTurno,4);//4 es el estado AUSENTE
        ...
        public function DerivarActual(){
            ...
            if($actual){
                $turnohistorial=new TurnoHistorial();
                $turnohistorial->CierraEstado($idTurno); //cierra el atendido
