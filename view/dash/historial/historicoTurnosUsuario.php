  ...
  <section class="wrapper my-5 site-min-height">
    <div class="row">
      ...
      <div class="border-head">
        <h3><i class="fa fa-angle-right"></i> HISTORIAL DE TURNOS POR USUARIO</td></h3>
      </div> 
        ...
        <table class="table table-compact table-striped table-hover " id="turnos_id">
                ...
                ?>
                  <tr>
                    ...
                    <td><span class="badge badge-primary" style="font-size:13px"><?=$listarTurnos->nombreEstadoTurno?></span></td>
