<body>
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper mt-5 site-min-height">
        <div class="border-head">
          <h3 class="mt-3"><i class="fa fa-angle-right"></i>  BUSCAR DE TURNOS DE PERFIL</td></h3>
        </div> 
        <!-- DATE TIME PICKERS -->
          <div class="row ">
            <div class="col-lg-12">
              <div class="form-panel">
                <form class="form-vertical  style-form" action="?c=usuario&a=HistoricoTurnosPerfil" method="post">
