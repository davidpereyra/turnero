    ...
    <section id="main-content">
      <section class="wrapper mt-5 site-min-height">
        <div class="border-head">
          <h3><i class="fa fa-angle-right"></i> ESTADISTICAS DE TURNOS DE USUARIO</td></h3>
        </div> 
        <!-- DATE TIME PICKERS -->
          <div class="row">
            <div class="col-lg-12">
              <div class="form-panel">
                <form class="form-vertical  style-form" action="?c=Usuario&a=EstadisticasUsuario" method="post">
