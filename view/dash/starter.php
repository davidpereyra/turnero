    ...
    <header class="header black-bg">
      ...
      <div class="nav notify-row" id="top_menu">
        ...
        <ul class="nav top-menu">
          <!-- settings start -->
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="?c=usuario&a=InicioDash#">
              <i class="fa fa-tasks"></i>
              <span class="badge bg-theme">8181</span>
              </a>
          ...
          <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="?c=usuario&a=InicioDash#">See all messages</a>
              </li>
            </ul>
          </li>
          <!-- inbox dropdown end -->
          ...
          <li id="header_notification_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended notification">
              ...
              <li>
                <a href="?c=usuario&a=InicioDash#">See all notifications</a>
              </li>
            </ul>
          </li>
            ...
            <div class="row">
              <div class="col-lg-4 col-md-4 col-sm-4 mb">
                <div class="product-panel-2 pn">
                  ...
                  <img src="assets/img/product.jpg" width="100" alt="">
